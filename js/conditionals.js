...
//         alert("Goldfish are" + " " + colorName);
//     }
//     else if (colorName === "yellow") {
//         alert("Bananas are" + " " + colorName);
//     }
//     else if (colorName === "green") {
//         alert("Lettuce is" + " " + colorName);
//     }
//     else if (colorName === "indigo") {
//         alert("Blackberries are" + " " + colorName);
//     }
//     else if (colorName === "violet") {
//         alert("Blueberries are" + " " + colorName);
//     }
//     else
 ...
 */
// var colorName = prompt("Enter a color please...");
//
// function analyzeColor(colorName) {
//     switch (colorName) {
//         case "red":
